...
/**
 * DataTable — card-wrapped table with warm border styling.
 *
 * Replaces raw HTML <table> markup in slides.md. Uses the `card` UnoCSS
 * shortcut for the visual shell and applies warm-token borders + muted header
    ...
    <table class="w-full text-sm">
      ...
      <tbody class="text-body">
        <tr
          ...
          :key="ri"
          :class="[
            'border-b border-warm-300/60 dark:border-warm-800/50',
