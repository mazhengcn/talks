...
export default defineConfig({
  theme: {
    ...
    //
    // OS-native first: macOS→PingFang/Songti  Linux→Noto  Windows→YaHei/SimSun
    // Chinese fonts are system fonts — no web font download needed.
  ...
  shortcuts: {
    ...
    // Display: Noto Serif SC — academic authority
