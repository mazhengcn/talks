...
<div class="mt-10 mx-4">
  ...
  <div class="flex justify-between w-full mt-5">
    <div class="flex flex-col items-center text-center w-1/5 px-1 space-y-1">
      ...
      <h3 class="!text-sm !font-bold leading-tight">数学与应用数学学士</h3>
    ...
    <div class="flex flex-col items-center text-center w-1/5 px-1 space-y-1">
      ...
      <h3 class="!text-sm !font-bold leading-tight">Golomb 访问助理教授</h3>
    ...
    <div class="flex flex-col items-center text-center w-1/5 px-1 space-y-1">
      ...
      <h3 class="!text-sm !font-bold leading-tight">长聘教轨副教授</h3>
...
<div class="space-y-4 mt-4">
  ...
  <div class="card p-5">
    <h3 class="!text-base !font-bold mb-2">架构：解耦分支</h3>
    <div class="grid grid-cols-2 gap-4">
...
<div class="grid grid-cols-2 gap-8 mt-6">
  <div class="space-y-4">
    ...
    <div class="card p-5">
      <h4 class="!text-sm !font-bold mb-2">经典方法：手工设计正则化</h4>
      <p class="text-sm text-muted-foreground">
...
<div class="space-y-5 mt-4">
  ...
  <div class="card p-5">
    <h3 class="!text-base !font-bold mb-2">核心算法贡献</h3>
    <div class="grid grid-cols-2 gap-4">
      <div class="space-y-2">
        <h4 class="!text-sm !font-bold">ODE 逆向采样器</h4>
      ...
      <div class="space-y-2">
        <h4 class="!text-sm !font-bold">自适应范数修正</h4>
        <p class="text-xs text-muted-foreground">
...
<div class="space-y-4 mt-4">
  ...
  <div class="card p-5">
    <h3 class="!text-base !font-bold mb-2">两项核心创新</h3>
    <div class="space-y-4">
      <div>
        <h4 class="!text-sm !font-bold">1. Wasserstein-2 数据一致性势函数</h4>
      ...
      <div>
        <h4 class="!text-sm !font-bold">2. 预条件引导逆向扩散</h4>
        <p class="text-xs text-muted-foreground mt-1">
...
<div class="grid grid-cols-2 gap-6 mt-6">
  <div class="card p-5 space-y-3">
    <h3 class="!text-base !font-bold">一般理论</h3>
    <p class="text-sm text-muted-foreground">
  ...
  <div class="card p-5 space-y-3">
    <h3 class="!text-base !font-bold">精确可解模型</h3>
    <p class="text-sm text-muted-foreground">
  ...
  <div class="card p-5 space-y-3">
    <h3 class="!text-base !font-bold">相图</h3>
    <p class="text-sm text-muted-foreground">
  ...
  <div class="card p-5 space-y-3">
    <h3 class="!text-base !font-bold">工程影响</h3>
    <p class="text-sm text-muted-foreground">
...
<div class="max-w-3xl mx-auto mt-8 space-y-4">
  <div class="card p-5">
    <h3 class="!text-base !font-bold mb-3">国家自然科学基金</h3>
...
<div class="max-w-3xl mx-auto mt-8 space-y-4">
  ...
  <div class="card p-5">
    <h3 class="!text-base !font-bold mb-2">开源软件</h3>
...
<div class="space-y-5 mt-4">
  ...
  <div class="grid grid-cols-2 gap-4">
    <div class="card p-4">
      <h4 class="!text-sm !font-bold mb-2">科学目标</h4>
      <p class="text-xs text-muted-foreground">
    ...
    <div class="card p-4">
      <h4 class="!text-sm !font-bold mb-2">核心挑战</h4>
      <p class="text-xs text-muted-foreground">
...
<div class="text-center space-y-10">
  ...
  <h1 class="!text-5xl !font-bold">谢谢</h1>
...
<div class="grid grid-cols-2 gap-6 max-w-3xl mx-auto mt-8">
  <div class="card p-5 space-y-3">
    <h3 class="!text-base !font-bold">获奖与荣誉</h3>
  ...
  <div class="card p-5 space-y-3">
    <h3 class="!text-base !font-bold">学术服务</h3>
    <ul class="text-sm text-body space-y-2">
