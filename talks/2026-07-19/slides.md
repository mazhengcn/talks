...
<div class="space-y-10">
  ...
  <div class="space-y-1.5">
    ...
    <p class="text-sm text-subtle">唐敏、竺烨锟，项目负责人：王涵、谌稳固</p>
  </div>
</div>
...
$$
  ...
  <div class="flex justify-around items-center gap-6 text-body-sm">
    <div><strong>$I(r,\Omega)$:</strong> 相空间 $(r,\Omega)$ 处的辐射强度</div>
    <div><strong>$\mu_t(r)$:</strong> 总截面</div>
    <div><strong>$\mu_s(r)$:</strong> 散射截面</div>
    <div><strong>$p(\Omega,\Omega^*)$:</strong> 散射核</div>
  </div>
</Card>
