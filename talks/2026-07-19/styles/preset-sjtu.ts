  ...
  return {
    ...
    rules: [
      ...
      [
        ...
        {
          "background-image":
            "linear-gradient(120deg, #0074e6 0%, #00b3ff 40%, #e100ff 100%)",
      ...
      [
        ...
        {
          "background-image":
            "linear-gradient(120deg, #ff8200 0%, #ffb300 50%, #00ffe7 100%)",
          "background-clip": "text",
          "-webkit-background-clip": "text",
          color: "transparent",
        },
      ...
      [
        ...
        {
          "background-image":
            "linear-gradient(120deg, #00b3ff 0%, #b300ff 50%, #00ffb3 100%)",
          "background-clip": "text",
          "-webkit-background-clip": "text",
          color: "transparent",
        },
      ...
      [
        ...
        {
          "box-shadow":
            "0 0 20px rgba(0, 102, 204, 0.3), 0 0 40px rgba(0, 102, 204, 0.1)",
        },
      ],
      [
        "glow-sjtu-dark",
        {
          "box-shadow":
            "0 0 20px rgba(54, 172, 255, 0.5), 0 0 40px rgba(54, 172, 255, 0.3)",
        },
      ],
      [
        "glow-tech",
        {
          "box-shadow":
            "0 0 20px rgba(14, 165, 233, 0.3), 0 0 40px rgba(14, 165, 233, 0.1)",
        },
      ],
      [
        "glow-tech-dark",
    ...
    shortcuts: {
      ...
      "hover-primary":
        "hover:bg-sjtu-700 dark:hover:bg-sjtu-300 hover:text-white dark:hover:text-neutral-900",
      "hover-secondary":
      ...
      "code-block":
        "bg-neutral-100 dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-600 rounded-lg",
      "code-block-simple":
        "bg-white/60 dark:bg-neutral-900/60 backdrop-blur-sm border border-neutral-200/60 dark:border-neutral-700/60 rounded-lg font-mono shadow-sm",
      "code-inline":
        "bg-white/40 dark:bg-neutral-800/40 backdrop-blur-sm text-sjtu-700 dark:text-sjtu-300 px-2 py-1 rounded border border-sjtu-200/30 dark:border-sjtu-600/20",
      ...
      "equation-block":
        "bg-white/20 dark:bg-black/10 rounded-lg p-2 border border-white/10",
